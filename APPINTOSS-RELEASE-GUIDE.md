...
4. 앱 ID 또는 appName이 콘솔에 등록된 `unmyeonglab`과 일치하는지 확인한다.
...
- 공식 업로드 후보: `appintoss/unmyeonglab.ait`
- 보조 ZIP: `appintoss/dist-appintoss/unmyeonglab-appintoss.zip`
...
5. 공유 링크가 `intoss://unmyeonglab/...` 형태로 열리는지 확인
